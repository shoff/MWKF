namespace MWKF.Api.Services
{
    ...
    public sealed class Ioc
    {
        ...
        ///   Gets the instance.
        /// </summary>
        public static Ioc Instance => instance;
            ...
            where TU : T
        {
            ...
            {
                throw new ArgumentNullException(nameof(dependencyPropertyValue));
            }
            if (string.IsNullOrWhiteSpace(key))
            {
                throw new ArgumentNullException(nameof(key));
        ...
        public object Resolve(string key)
        {
            ...
            if (!ReferenceEquals(null, componentModel))
            {
                ...
                {
                    throw new ComponentNotFoundException("key", $"Could not resolve component named {key}");
                }
        ...
        internal sealed class RegisteredComponents : List<RegisteredComponent>
        {
            ...
            public void AddComponent(RegisteredComponent registeredComponent)
            {
                ...
                {
                    throw new ArgumentNullException(nameof(registeredComponent));
                }
