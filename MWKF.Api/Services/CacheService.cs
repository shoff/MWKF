namespace MWKF.Api.Services
{
    ...
    public sealed class CacheService : ICacheService
    {
        ...
        public T TryGet<T>(string key, Func<T> serviceFunc, ICacheItemProperties cacheItemProperties)
        {
            if (serviceFunc == null)
            {
                throw new ArgumentNullException(nameof(serviceFunc));
            }
        ...
        public int Count => this.cacheIsValid ? this.cache.Count : 0;

        /// <summary>
        ///   Gets the no absolute expiration.
        /// </summary>
        /// <value> The no absolute expiration. </value>
        public DateTime NoAbsoluteExpiration => DateTime.MaxValue;

        /// <summary>
        ///   Gets the no sliding expiration.
        /// </summary>
        /// <value> The no sliding expiration. </value>
        public TimeSpan NoSlidingExpiration => TimeSpan.Zero;
