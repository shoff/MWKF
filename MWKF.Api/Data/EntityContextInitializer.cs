...
namespace AUSKF.Api.Data
{
    public sealed class EntityContextInitializer : DropCreateDatabaseIfModelChanges<DataContext>, ISingletonLifestyle
    {
        ...
        private void AddKendoRanks(DataContext context)
        {
            ...
            {
                new KendoRank {  KendoRankName="Mudansha", KendoRankNumeric = 10,
                    Eligibility ="For those with no rank.",
                    ConsentingExaminersRequired = 0, MinimumRankOfExaminers = "-", NumberOfExaminers=0,
                    CreateUser = "tstron",
                    ModifyUser = "tstron" },
