...
namespace AUSKF.Api.Exceptions
{
    ...
    public sealed class ParameterNullException : ArgumentNullException
    {
        ...
        /// </value>
        public Type DeclaringType => this.declaringType;
        ...
        public Type FailingParamterType => this.failingParamterType;
        ...
        /// </value>
        public MethodBase DeclaringMethod => this.declaringMethod;
    }
}