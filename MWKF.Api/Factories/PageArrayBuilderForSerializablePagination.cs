...
namespace AUSKF.Api.Factories
{
    public sealed class PageArrayBuilderForSerializablePagination<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageArrayBuilderForSerializablePagination{T}"/> class.
        /// </summary>
