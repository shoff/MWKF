...
namespace AUSKF.Api.Factories
{
    public sealed class PageArrayBuilder<T>
    {
        ...
        /// <summary>
        /// Creates the specified base pagination.
        /// </summary>
        /// <param name="basePagination">The base pagination.</param>
        /// <returns></returns>
        ...
        internal bool InLowerBounds => this.currentPage <= this.boundSize;

        /// <summary>
        ///   Gets a value indicating whether [in upper bounds].
        /// </summary>
        /// <value> <c>true</c> if [in upper bounds]; otherwise, <c>false</c> . </value>
        internal bool InUpperBounds => this.currentPage >= (this.totalPages - this.boundSize);
